...
@section('title', __('New Employee Salary'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        ...
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Employee Salary')) }}</h4>
        </div>
    </div>

    <div class="card shadow-sm col-md-12">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.expense.salary.create') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="payment_method" required>
                                        ...
                                        @foreach($payment_methods as $payment_method)
                                            <option value="{{$payment_method}}" {{(old("payment_method") == $payment_method) ? "selected" : ""}}>{{$payment_method}}</option>
                                        @endforeach
                            ...
                            <div class="form-group row @error('month_of_salary') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="month" name="month_of_salary" id="month_of_salary" class="form-control"
                                        value="{{old('month_of_salary') }}" required>
                            ...
                            <div class="form-group row @error('salary') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="salary" id="salary" step="0.0001" min="0.0001"
                            ...
                            <div class="form-group row @error('bonus') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="bonus" id="bonus" step="0.0001" min="0"
                                        value="{{ old('bonus') }}" placeholder="{{ __('Write Amount') }}" required>
                                    @error('bonus')
                                    <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="p-sm-3">
                            ...
                            <div class="form-group row @error('total_salary') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="total_salary" id="total_salary" step="0.0001" readonly
                                        value="{{ old('total_salary') }}" placeholder="{{ __('Write Amount') }}" required>
                                    @error('total_salary')
                                    <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row @error('trans_date') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" name="trans_date" id="trans_date" max="{{ now()->format('Y-m-d') }}" class="form-control"
                            ...
                            <div class="form-group row @error('note') error @enderror">
                                <label class="col-sm-3 col-form-label" for="note">{{ __('Note') }}</label>
                                <div class="col-sm-9">
