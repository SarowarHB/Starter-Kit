...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm col-md-8">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.website.event.create') }}" enctype="multipart/form-data">
                @csrf
                <div class="p-sm-3">
                    ...
                    <div class="form-group row @error('title') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="title" value="{{ old('title') }}"
                                placeholder="{{ __('Write Your Blog Title') }}" required>
                            @error('title')
                            <p class="error-message">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group custom-dt-group">
                                <input type="text" class="form-control " name="start"
                                    value="{{ old('start') }}" placeholder="{{ __('Ex. 1980-01-25 15:44') }}"
                                    required readonly>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group custom-dt-group">
                                <input type="text" class="form-control" name="end" value="{{ old('end') }}"
                                    placeholder="{{ __('Ex. 1980-01-25 15:44') }}" required readonly>
                                <div class="input-group-append" style="cursor: pointer">
