...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm col-md-8">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.website.blog.update', $blog->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="p-sm-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="blog_type" required>
                                ...
                                @foreach($blog_type as $value)
                                    <option value="{{ $value }}" {{(old("blog_type", $blog->blog_type) == $value) ? "selected" : ""}}>
                    ...
                    <div class="form-group row @error('short_description') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="short_description" class="form-control"
                                placeholder="{{ __('Write Short Description') }}" rows="4">{{ old('short_description', $blog->short_description) }}</textarea>
...
<script>
    $(document).ready(function () {
        var tags = JSON.parse(<?php echo json_encode($blog->tags) ?>) ;
        console.log(tags);
