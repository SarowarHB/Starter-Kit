...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack(route('admin.ams.supplier.index')) !!}
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Supplier')) }}</h4>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.ams.supplier.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="supplier_type" required>
                                        ...
                                        @foreach($types as $key => $type)
                                            <option value="{{ $type->id }}" {{(old("supplier_type") == $type->id) ? "selected" : ""}}>
                            ...
                            <div class="form-group row @error('email') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email"
                                        value="{{ old('email') }}" placeholder="{{ __('example@example.com') }}">
                                    @error('email')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row @error('phone') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="number" name="phone" value="{{old('phone')}}" class="form-control" placeholder="{{ __('013 355 666') }}">
                                    </div>
                                    @error('phone')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="form-group row @error('contact_person') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="contact_person"
                                        value="{{ old('contact_person') }}" placeholder="{{ __('example@example.com') }}">
                            ...
                            <div class="form-group row @error('address') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" name="address"
                                            value="{{ old('address') }}" placeholder="{{ __('Address') }}" rows="8" ></textarea>
                                        @error('address')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row @error('company') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="company"
                                        value="{{ old('company') }}" placeholder="{{ __('example@example.com') }}">
                                    @error('company')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row @error('logo') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="file-upload-section">
                                            <input name="logo" type="file" value="{{old('logo')}}" class="form-control d-none" allowed="png,gif,jpeg,jpg">
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info" value="{{old('logo')}}" disabled="" readonly placeholder="Size: 200x200 and max 500kB">
