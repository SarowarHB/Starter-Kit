...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack(route('admin.ams.stock.index')) !!}
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Stock')) }}</h4>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.ams.stock.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-sm-3">
                            ...
                            <div class="form-group row @error('quantity') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="quantity" id="quantity"
                                        value="{{ old('quantity') }}" min="1" placeholder="{{ __('Quantity') }}"
                                        required>
                                    @error('quantity')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="form-group row @error('unit_price') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" min="0" step="0.01" name="unit_price" id="price"
                                        value="{{ old('unit_price') }}" placeholder="{{ __('Unit Price') }}"
                                        required>
                                    @error('unit_price')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="p-sm-3 col-sm-12">
                                ...
                                <div class="form-group row @error('mac_id') error @enderror" id="macDiv">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="mac_id"
                                            value="{{ old('mac_id') }}" placeholder="{{ __('MAC ID') }}">
                                        @error('mac_id')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row @error('warranty_date') error @enderror" id="warrentyDiv">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="warranty_date" min="{{ now()->format('Y-m-d') }}" id="warranty_date" class="form-control"
                                ...
                                <div class="form-group row @error('testing_date') error @enderror" id="testingDiv">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="testing_date" min="{{ now()->format('Y-m-d') }}" id="testing_date" class="form-control"
                                            value="{{old('testing_date')}}">
                                        @error('testing_date')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row @error('purchase_date') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="purchase_date" max="{{ now()->format('Y-m-d') }}" id="purchase_date" class="form-control"
                                ...
                                <div class="form-group row @error('note') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" name="note" class="form-control"
                                            placeholder="{{ __('Write About Stock') }}" rows="4">{{ old('note') }}</textarea>
                                        @error('note')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
...
@push('scripts')
@vite('resources/admin_assets/js/pages/ams/stock/create.js')
@endpush
